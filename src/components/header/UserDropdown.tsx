...
export default function UserDropdown() {
  ...
  const handleSignOut = async () => {
    try {
      ...
      // Then navigate to the home page using window.location for a full page refresh
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="block mr-1 font-medium text-theme-sm">Samuelson Egelege</span>
        <svg
